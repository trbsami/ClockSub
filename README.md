...
برای تغییر لینک پشتیبانی در خط 288 فایل، عبارت `YOUR-TELEGRAM-USERNAME` را با نام کاربری تلگرام خود جایگزین کنید.



### 📲 تغییر لینک‌های دانلود برنامه‌ها

جهت تغییر مسیر دانلود برنامه‌ها، لینک‌های موجود بین خط‌های 341 تا 353 را به لینک دلخواه خود ویرایش کنید. به‌صورت پیش‌فرض تمام اپلیکیشن‌ها اتوماتیک آخرین نسخه را دریافت می‌کنند به‌جز نسخه اندروید اپلیکیشن sing-box.
